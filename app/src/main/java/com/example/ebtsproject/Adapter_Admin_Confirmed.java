...
public class Adapter_Admin_Confirmed extends RecyclerView.Adapter<Adapter_Admin_Confirmed.MyViewHolder>{

    private ArrayList<Model_Book> mList;
    private Context context;

    public Adapter_Admin_Confirmed(Context context, ArrayList<Model_Book> mList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.itemlist_admin_confirm, parent, false);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            btnDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(view.getContext(), Admin_Confirmed.class);
